...
The crosswalk was constructed using:

Official ISCO–SOC descriptions

Task similarity

Industry alignment

Skill/knowledge overlap

Manual expert review

## Cleaning & Validation Principles
The raw ISCO–SOC mapping contains many systematic errors.
...
| Column | Description |
| --- | --- |
| ``isco_88`` | ISCO-08 4-digit occupation code |
...
> Eliza (2026). ISCO–SOC Crosswalk (Cleaned & Validated). GitHub Repository.
